...
> **Status:** Phase 4 (GUI) is complete — the WPF app now has the visual keyboard and a tray icon (minimize-to-tray, arm/disarm from the tray menu). Next: hands-on testing, then roadmap item 5 (per-app profiles).
