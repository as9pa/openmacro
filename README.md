...
> **Status:** timeline editing is now complete — every part of a macro is mutable after recording (see below). Next: hands-on testing, then roadmap item 5 (per-app profiles).
