...
> **Status:** drag-reorder is now live (the row moves with the mouse and drops where you see it) and double-click toggles a macro on/off. Next: hands-on testing, then roadmap item 5 (per-app profiles) or the Home/Editor split.
