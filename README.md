...
|---|---|---|
| `openmacro-v0.3.0-win-x64.exe` | ~72 mb | **no** — built in runtime |
| `openmacro-v0.3.0-win-x64-dotnet.zip` | ~510 kb | **yes** — [.NET 10 desktop runtime](https://dotnet.microsoft.com/en-us/download) |
